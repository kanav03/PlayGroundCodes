...
let addedHR = heaertRate1+heaertRate2+heaertRate3
...
let heaertRate1D = Double(heaertRate1)
let heaertRate2D = Double(heaertRate2)
let heaertRate3D = Double(heaertRate3)

let addedHRD = heaertRate1D+heaertRate2D+heaertRate3D
